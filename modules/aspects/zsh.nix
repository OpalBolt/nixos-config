{ ... }:
{
  den.aspects.zsh.homeManager = { config, lib, ... }: {
    programs.zsh = {
      enable = true;
      ...
      zplug = {
        ...
        plugins = [
          ...
          { name = "zsh-users/zsh-autosuggestions"; tags = [ "from:github" "as:plugin" ]; }
          { name = "zsh-users/zsh-syntax-highlighting"; tags = [ "from:github" "as:plugin" "defer:2" ]; }
          { name = "svenXY/timewarrior"; tags = [ "from:github" "as:plugin" ]; }
        ];
      };
      shellAliases = {
